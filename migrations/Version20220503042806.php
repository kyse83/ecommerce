 ...
 */
final class Version20220503042806 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carrier CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE decription decription LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
